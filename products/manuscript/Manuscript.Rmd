...
Figure \@ref(fig:resultfigure2) shows a boxplot figure produced by one of the R scripts using the new sex variable we added to the spreadsheet.
...
Figure \@ref(fig:resultfigure3) shows a scatterplot figure produced by one of the R scripts using the new age variable we added to the spreadsheet.
...
Figure \@ref(fig:resultfigure) shows the original scatterplot figure produced plotting height vs weight
